...
class CountryStateExpandableAdapter(
            ...
            ExpandableCountryModel.PARENT -> {
                for (child in row.countryParent.states) {
                    countryStateModelList.add(
                        ++nextPosition,
                        ExpandableCountryModel(ExpandableCountryModel.CHILD, child)
                    )
                }
    ...
    class CountryStateParentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        internal var layout: ConstraintLayout =
            itemView.findViewById(R.id.country_item_parent_container)
        internal var countryName: TextView = itemView.findViewById(R.id.country_name)
    ...
    class CountryStateChildViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        internal var layout: ConstraintLayout =
            itemView.findViewById(R.id.country_item_child_container)
        internal var stateName: TextView = itemView.findViewById(R.id.state_name)
        internal var capitalImage: TextView = itemView.findViewById(R.id.capital_name)
